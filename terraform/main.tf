...
#     type = "UserAssigned"
#     identity_ids = [
#       azurerm_user_assigned_identity.kvcsidriver.id
#     ]
#   }
#   kubelet_identity {
...
resource "azurerm_role_assignment" "aks_role_assignemnt_msi" {
  scope                             = azurerm_user_assigned_identity.kvcsidriver.id
  role_definition_name              = "Managed Identity Operator"
  principal_id                      = azurerm_user_assigned_identity.kvcsidriver.principal_id
